...
plt.text(0 , 110 , 'Train Score: %.2f RMSE' % (trainScore))
plt.text(0 , 100 , 'Test Score: %.2f RMSE' % (testScore))
plt.text(0 , 90 , 'Look_back: %d' % (look_back))
plt.text(0 , 80 , 'Epochs: %d' % (epochs))
plt.text(0 , 70 , 'Batch_size: %d' % (batch_size))
plt.text(0 , 60 , 'Neurons: %d' % (neurons))
plt.show()
